...
@section('content')
    ...
    <div class="container">
        <div class="imgvarones">
            <img class="imagenvarones mt-3" src="{{ asset('images/grupoPastoral.png') }}" alt="pastores">
        </div>
    </div>
        ...
        <div class="row d-flex justify-content-center mt-4">
            <div class="alert alert-primary col-8 " role="alert">
                <div>
                    ...
                    <p>La meta del cuerpo de Pastoral de la iglesia Jetell es proveer un punto común en donde toda la congregacion puedan converger dentro del cuerpo de la iglesia , a fin de que puedan recibir asistencia espiritual en el desarrollo de sus vidas en el área personal, familiar, social y ministerial.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row col-8">
            <div class="alert alert-primary" role="alert">
                <h2 class="text-center">El Cuerpo Pastoral existe para:</h2>
            </div>
        </div>
    </div>
    <div>
