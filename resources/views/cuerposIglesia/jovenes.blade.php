        ...
        <div class="row d-flex justify-content-center mt-4">
            <div class="alert alert-primary col-8 " role="alert">
                <div>
                    ...
                    <p>La meta del cuerpo de Jóvenes de la iglesia Jetell es proveer un punto común en donde todos los
                        jóvenes puedan converger dentro del cuerpo de la iglesia local, a fin de que puedan recibir
    ...
    <div class="container">
        <div class="row col-8">
            <div class="alert alert-primary" role="alert">
                <h2 class="text-center">El Cuerpo de Jovenes existe para:</h2>
            </div>
        </div>
    </div>
    <div>
                ...
                <div class="accordion-item ">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            *Orientar a los jóvenes de la Iglesia local hacia las sagradas escrituras con el propósito de
