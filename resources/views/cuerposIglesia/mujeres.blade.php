...
@section('content')
    ...
    <div class="container">
        <div class="imgvarones">
            <img class="imagenvarones mt-3" src="{{ asset('images/fotoMujeres.png') }}" alt="mujeres">
        </div>
    </div>
        ...
        <div class="row d-flex justify-content-center mt-4">
            <div class="alert alert-primary col-8 " role="alert">
                <div>
                    ...
                    <p>La meta del cuerpo de Mujeres de la iglesia Jetell es proveer un punto común en donde todas las mujeres puedan converger dentro del cuerpo de la iglesia local, a fin de que puedan recibir asistencia espiritual en el desarrollo de sus vidas en el área personal, familiar, social y ministerial.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row col-8">
            <div class="alert alert-primary" role="alert">
                <h2 class="text-center">El Cuerpo de Mujeres existe para:</h2>
            </div>
        </div>
    </div>
    <div>
            ...
            <div class="accordion" id="accordionFlushExample">
                <div class="accordion-item ">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            *Orientar a las Mujeres de la Iglesia local hacia las sagradas escrituras con el propósito de
                ...
                <div class="accordion-item ">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            *Apoyar a los jóvenes en el desarrollo de una vida de oración efectiva con Dios.
                        </div>
                    </div>
                </div>
                <!-- Repite el siguiente bloque para cada objetivo -->
                <div class="accordion-item ">
                    ...
                    <div id="flush-collapseFour" class="accordion-collapse collapse"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            *Guiar a los jóvenes en el servicio a través de una experiencia personal e íntima con Dios.
                        </div>
                    </div>
                </div>
                <!-- Repite el siguiente bloque para cada objetivo -->
                <div class="accordion-item ">
                    ...
                    <div id="flush-collapseFive" class="accordion-collapse collapse"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            *Ayudar a los jóvenes a descubrir y trabajar en el perfeccionamiento sus dones espirituales
                        </div>
                    </div>
                    <!-- Repite el siguiente bloque para cada objetivo -->
                    <div class="accordion-item">
